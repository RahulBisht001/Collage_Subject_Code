...
void parabolicFit(int n, double x[], double y[]) {
    ...
    double a = (sumX2Y * (sumX2 * sumX2 - sumX * sumX3) + sumXY * (sumX * sumX4 - sumX2 * sumX3) - sumY * (sumX * sumX4 - sumX2 * sumX3))
                / (sumX2 * (sumX2 * sumX2 - sumX * sumX3) + sumX * (sumX * sumX4 - sumX2 * sumX3) + n * (sumX4 * sumX - sumX2 * sumX2));
